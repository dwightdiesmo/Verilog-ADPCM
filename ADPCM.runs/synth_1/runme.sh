...
HD_PWD='C:/Users/dwigh/Xilinx/ADPCM/ADPCM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADPCM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADPCM.tcl
